                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                        data-bs-target="#modaledit{{ $item->id }}" id="btn-edit">
                                        <i class="fas fa-edit"></i>
                                    </button>

                                    <a href="{{ route('proker.delete', $item->id) }}" class="btn btn-danger"
                                        onclick="return confirm('Yakin Hapus Data ?')"> <i class="fas fa-trash-alt"></i>
                                    </a>
                                </td>
                            </tr>
                            </td>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="/ubahproker/{{ $p->id }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="namakategori" class="form-select" name="semester">
                                    <option selected>Pilih Semester </option>
                                    <option value="Semester 1" {{ $p->semester = 'Semester 1' ? 'selected' : '' }}>
                                        Semester 1 </option>
