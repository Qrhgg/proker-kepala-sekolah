...
class ProkerController extends Controller
{
    ...
    public function reportProgramKerja(Request $request)
    {
        ...
        return view('proker.report', $data);
    }

    public function PrintReportProgramKerja(Request $request)
    {
        $kategori = $request->id_kategori ?? null;
        $tahun = $request->tahun ?? null;
        $search = $request->search ?? null;
        ...
        $pdf = PDF::loadView('proker.print', $data);
